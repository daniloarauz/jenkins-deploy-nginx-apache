    ...
    stages {
        stage('Create  directory for the WEB Application')        
       {
            steps {
                ...
                sh 'rm -rf /home/oarauz/app-web'
                //Create the directory
                sh 'mkdir /home/oarauz/app-web'               
            }
        }
        ...
        stage('Create the containers in Parallel') {
            parallel{
                ...
                {           
                    ...
                    sh 'docker run -dit --name app-web-apache -p 9100:80  -v /home/oarauz/app-web:/usr/local/apache2/htdocs/ httpd'
                    }
                }
                stage('Create the Nginx container') {
                   steps {
                   echo 'Creating the Apache container...'
                   sh 'docker run -dit --name app-web-nginx -p 9200:80  -v /home/oarauz/app-web:/usr/share/nginx/html nginx'         
                   }
                }       
            }   
        }
        ...
        stage('Copy the web application to the container directory') {
            steps {
                ...
                sh 'cp -r web/* /home/oarauz/app-web'
            }
        }
    }
